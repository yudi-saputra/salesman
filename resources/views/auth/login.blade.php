                                ...
                                <div class="card-body p-0 auth-header-box rounded-top">
                                    <div class="text-center p-3">
                                        <a href="" class="logo logo-admin">
                                            <img src="assets/images/logo-sm.svg" height="50" alt="logo"
                                                class="auth-logo">
                                        </a>
                                        <h4 class="mt-3 mb-1 fw-semibold text-white fs-18">Let's Get Started</h4>
                                        <p class="text-muted fw-medium mb-0">Sign in to continue to Salesman.</p>
                                    </div>
                                </div>
                                <div class="card-body pt-0">

                                    @if ($errors->has('kode_reseller'))
                                        <div class="alert alert-danger alert-dismissible fade show shadow-sm mb-0 d-flex align-items-center"
                                            role="alert">
                                            <div
                                                class="d-inline-flex justify-content-center align-items-center thumb-xs bg-danger rounded-circle me-2">
                                                <i class="fas fa-xmark text-white"></i>
                                            </div>
                                            <div class="flex-grow-1">
                                                {{ $errors->first('kode_reseller') }}
                                            </div>
                                    ...
                                    <form class="my-4" action="{{ route('login-store') }}" method="POST">
                                        ...
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="text" class="form-control" id="kode_reseller"
                                                name="kode_reseller" placeholder="Enter kode reseller">
                                        </div><!--end form-group-->
