        ...
        <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
            ...
            <li class="dropdown topbar-item">
                ...
                <a class="nav-link dropdown-toggle arrow-none nav-icon" data-bs-toggle="dropdown" href="#"
                    ...
                    <span
                        class="thumb-md d-flex justify-content-center align-items-center bg-body-secondary text-body-emphasis rounded-circle fw-semibold">
                        {{ $initials }}
                    </span>
                </a>
                <div class="dropdown-menu dropdown-menu-end py-0">
                    <div class="d-flex align-items-center dropdown-item py-2 bg-secondary-subtle">
                        <div class="d-flex align-items-center">
                            <span
                                class="thumb-lg justify-content-center d-flex align-items-center bg-body-secondary text-body-emphasis rounded-circle me-2">
                                {{ $initials }}
                            </span>
